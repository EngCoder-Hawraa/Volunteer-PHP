...
<div style="border:4px solid white;" data-placement="top" title="عدد المؤسسات" class="mr-5 font-size3 text-white mt-3 badge rounded-circle pt-3 pb-3 pr-4 pl-4 Boxshadow bg-warning float-right"> --}}
    {{-- {{intitys.count}} --}}
</div>
{{-- <br><br><br> --}}

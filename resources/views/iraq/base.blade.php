...
<body>
    ...
    <nav class="Boxshadow nav navbar navbar-inverse navbar-expand-md bg-white navbar-light sticky-top">
        <div class="container-fluid">
            ...
            <img class="image-width image-height" src="/images/logo.png" alt="Logo">
    ...
    <!-- /* ======== Start Footer Page ======== */ -->
<footer class="main-footer bg-primary font-weight-bold mt-3 text-center text-white mb-0" style="height:60px;padding-top:20px;">
    <strong>Copyright &copy; 2020-2021 <a class="text-danger font-size1 text-decoration-none" href="https://codeforiraq.org">Code for IRAQ</a>.</strong> All rights reserved.
    <div class="float-right pr-5 d-none d-sm-inline-block text-warning mr-5">
        <b>Version</b> 1.0
    </div>
</footer>
<!-- /* ======== End Footer Page ======== */ -->
